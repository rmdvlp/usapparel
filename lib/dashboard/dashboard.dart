...
//chart for feelsLikeC
 ...
 /// Post/get Request for data fetching
  fetchData(int type) async{
   ...
   int hours = DateTime.now().hour;
   print("check date${pickedDate.subtract(new Duration(days: 30)).toString().replaceAll(
  ...
  //  };
   if(type ==1)
   {
     data = {
       ...
       "intervals": [
         "${pickedDate.subtract(new Duration(days: 1)).toString().replaceAll(
             ' ', 'T')}+05:00/${pickedDate1.toString().replaceAll(
             ' ', 'T')}+05:00"
       ]
   ...
   else if(type ==2)
     {
       data = {
         ...
         "intervals": [
           "${pickedDate.subtract(new Duration(days: 2)).toString().replaceAll(
               ' ', 'T')}+05:00/${pickedDate1.toString().replaceAll(
               ' ', 'T')}+05:00"
         ]
       };
   ...
   else if(type==3)
     {
       data = {
         ...
         "intervals": [
           "${pickedDate.subtract(new Duration(days: 7)).toString().replaceAll(
               ' ', 'T')}+05:00/${pickedDate1.toString().replaceAll(
               ' ', 'T')}+05:00"
         ]
       };
   ...
   else if(type ==4)
     {
       data = {
         ...
         "intervals": [
          " ${pickedDate.subtract(new Duration(days: 30)).toString().replaceAll(
               ' ', 'T')}+05:00/${pickedDate1.toString().replaceAll(
               ' ', 'T')}+05:00"
         ]
       };
  ...
  return CircularProgressIndicator();
   ...
   var uri = Uri.parse("https://iot.dev.onstak.io/services/core/api/v2/analytics/query");
   response = await http.post(uri, body: jsonEncode(data), headers: <String, String>{
   ...
   if (response.statusCode==200){
    ...
    print("${aqi.length.toString()}");
     ...
     for(int i=0; i<=aqi.length-1; i++){
       //tempC
       temCValueList.add("${aqi[i].result.avgTemp.toString().split(' ').last.split('.').first}");
       temCTimeList.add("${aqi[i].timestamp.toString().split(" ").first.split("-").last.split("-").last}");
       print("tecsting check$temCTimeList");
       //FeelLikeC
       feelLikeValueList.add("${aqi[i].result.feelsLikeCTemp.toString().split(' ').last.split('.').first}");
       print(feelLikeValueList);
       feelLikeTimeList.add("${aqi[i].timestamp.toString().split(" ").first.split("-").last}");
       //humidity
       humidityValueList.add("${aqi[i].result.avghumidity.toString().split(' ').last.split('.').first}");
       print(feelLikeValueList);
       humidityTimeList.add("${aqi[i].timestamp.toString().split(" ").first.split("-").last}");
     }
     Obx((){
       temCValueList;
       temCTimeList;
          ...
          appBar: AppBar(
            ...
            title: Column(
              children: [
                AutoSizeText(
                  'Usapparel',
                  style: TextStyle(fontSize: 24,color: AppConsts.primaryTextColor),
                ),
              ],
            ),
          ),
                                                    ...
                                                    children: [
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: DropdownButton(
                                                          ...
                                                          hint: Text("Hourly",style: TextStyle(color: Colors.white),),
                                                          value: dropDownValue,
                                                        ...
                                                        child: DropdownButton(
                                                          ...
                                                          items: [
                                                            ...
                                                            DropdownMenuItem(
                                                                ...
                                                                child: Text('Daily',style: TextStyle(color: Colors.white)),
                                                                onTap: () {
                                                                  feelLikeValueList.clear();
                                                                  feelLikeTimeList.clear();
                                                                  fetchData(2);
                                                        ...
                                                        child: DropdownButton(
                                                          ...
                                                          items: [
                                                            ...
                                                            DropdownMenuItem(
                                                                ...
                                                                child: Text('Daily',style: TextStyle(color: Colors.white)),
                                                                onTap: () {
                                                                  humidityValueList.clear();
                                                                  humidityTimeList.clear();
                                                                  fetchData(2);
